...
public class TestLogic extends MiniGameLogic
{
	...
	public TestLogic()
	{
		...
		items.add(new GameObjectContainer(20, 20, 500, 500,
				GameObject.RELATIVE_FROM_TOPLEFT, new GameObject[]
				{
						new GameObjectContainer(5, 5, 246, 246,
								GameObject.RELATIVE_FROM_TOPLEFT),
						new GameObjectContainer(5, 5, 246, 246,
								GameObject.RELATIVE_FROM_TOPRIGHT),
						new GameObjectContainer(5, 5, 246, 246,
								GameObject.RELATIVE_FROM_BOTTOMLEFT),
						new GameObjectContainer(5, 5, 246, 246,
								GameObject.RELATIVE_FROM_BOTTOMRIGHT) }));
